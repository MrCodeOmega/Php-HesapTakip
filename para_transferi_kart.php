<?php
 if($_POST){
		 ...
		 if(!$miktar){
            ...
            $kayit2 = $y->execute(array($gider_adi,$miktar,$gider_parabirimi_id,1));				
...
<h2>Para Transferi İşlemi</h2>
  <form action="" method="post">
    ...
    <input type="text" id="fname" name="gider_adi" placeholder="Hesap Adı Giriniz" value="Karttan Nakite Para Transferi" readonly="readonly">
	...
	<input type="radio" id="age1" name="gider_turu" value="0" checked> <label for="age1">Kredi</label>
